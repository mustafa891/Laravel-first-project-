...
@section('content')
    ...
    <div class="container">
        <div class="btn-add d-flex justify-content-end">
            <button class="btn custom2-btn">Add a new food</button>
        </div>
        <div class="foods">
            <h4 class="lead ">Create Food</h4>
                ...
                <form action="{{route('food.store')}}" method="POST" enctype="multipart/form-data">
                   @if(session('msg'))
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="exampleFormControlTextarea1" name="desc" style="height: 130px !important;" value="{{old('desc')}}"></textarea>
